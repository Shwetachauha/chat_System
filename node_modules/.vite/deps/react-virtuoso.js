            ...
            if (N.length > 0) {
              ...
              for (const tt of Zt(ut, D, K)) {
                ...
                for (let ct = lt; ct <= xt; ct++)
                  Ft.push({ data: q == null ? void 0 : q[ct], index: ct, offset: st, size: X }), st += X;
              }
            }
            if (!V)
            ...
            if (Et.length > 0 && (te > 0 || b > 0)) {
              ...
              if (te > 0 && D.index > pt) {
                ...
                for (let lt = D.index - 1; lt >= D.index - st; lt--) {
                  const ct = ((_a = Zt(ut, lt, lt)[0]) == null ? void 0 : _a.value) ?? D.size;
              ...
              if (b > 0 && K.index < Qt) {
                ...
                for (let X = K.index + 1; X <= K.index + st; X++) {
                  const xt = ((_b = Zt(ut, X, X)[0]) == null ? void 0 : _b.value) ?? K.size;
  ...
  ([
    ...
    return k(
      ...
      x(
        at(x(H, Ut(1)), c),
        $(W(S), l, v, p),
        B(([[y, O], u, g, C, z]) => O && g && (u == null ? void 0 : u({ context: z, totalCount: y, scrollingInProgress: C }))),
        P((y) => !!y),
        zt(0)
      ),
      (y) => {
