...
export const mockMessagesByChat: Record<string, Message[]> = {
  'chat-1': [
    ...
    { id: 'msg-1-4', chatId: 'chat-1', senderId: 'user-1', senderName: 'John Doe', content: 'Yes! Just submitted it 10 minutes ago. Let me know if you need any changes.', type: 'text', status: 'seen', replyTo: 'msg-1-3', reactions: [], readBy: [{ userId: 'user-2', readAt: '2026-05-15T09:12:00.000Z' }], createdAt: '2026-05-15T09:10:00.000Z', isEdited: false, isDeleted: false },
